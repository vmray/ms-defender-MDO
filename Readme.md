...
|:---------------|:-------------|:---------------- |
| 1.0.3          | `27-02-2026` | <ul><li>Improvement: Analyse email attachment related to User Reported Phishing or Jumk MDO alerts.</li><li>Improvement:Whitelist URLs .</li><li>Improvement: Configurable number of days for email in KQL query: first query with 24 hours, retry with configured email age.</li>Add Alert ID tags to submissions.<li>Improvement: Filter submissions by severity.</li></ul> |
